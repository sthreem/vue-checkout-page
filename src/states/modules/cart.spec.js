...
describe('cart state module', () => {
    ...
    describe('cartTotal getter', () => {
        ...
        it('should return total price of products in cart', () => {
            items.forEach(item => store.commit('cart/MODIFY_CART', item));
            const expectedTotal =
    ...
    describe('MODIFY_CART mutation', () => {
        ...
        it('should add new item to cart if does not exist already', () => {
            store.commit('cart/MODIFY_CART', item);
